// ─────────────────────────────────────────────────────────────────────────────
// VENDORED from simujaules (github.com/pedalhidro/simujaules) @ 1ba06ae — the
// canonical v2 energy engine. Treat as an upstream artifact: re-sync by copying
// simujaules/energy-worker.js + graph-engine.js, then re-apply the AMORA PATCH.
...
// correlate correctly. simujaules never runs concurrent `run` jobs, so its copy
