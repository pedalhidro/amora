/* leaflet-rotate 0.2.8 — dist/leaflet-rotate-src.js, vendorado VERBATIM de
 * https://cdn.jsdelivr.net/npm/leaflet-rotate@0.2.8/dist/leaflet-rotate-src.js
 * (https://github.com/Raruto/leaflet-rotate). Licença: GPL-3.0 — texto em
 * https://www.gnu.org/licenses/gpl-3.0.txt; combinável com o AGPL-3.0 do amora
 * (§13 das duas licenças). A versão legível (-src) é vendorada de propósito:
 * ela É o código-fonte correspondente. Não editar — os ajustes do amora
 * (panes, zona morta da pinça, Shift+roda, botão do norte) moram no app.js.
 * SHA-256 do arquivo original (tudo depois deste cabeçalho):
 * f90b3c0fdcdb187870d42191d42fd3cbe8621bfa18bfdf7c46cd839ed21722b6 */
(function (factory) {
